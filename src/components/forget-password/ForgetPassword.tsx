  ...
  return (
    <div className="relative w-full h-screen bg-gray-50">
      <div className="w-full flex justify-center mx-auto container ">
        ...
        <div className="sm:w-[460px] h-[550px] sm:h-[860px] w-10/12 z-10 flex rounded-[16px] items-center justify-end flex-col">
          <div className="w-full h-[450px] shadow-md bg-white px-[20px] py-[15px] z-10 flex rounded-[16px] flex-col">
            ...
            <div className="mt-[15px]">
              <div className="cursor-pointer w-full h-[40px] border flex justify-center items-center rounded-[8px] mt-[12px] bg-blue-500 text-white text-[14px] hover:scale-105 duration-500">
