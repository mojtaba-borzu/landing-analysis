...
} from '../../app/slice/forgetPasswordSlice'
...
function ResetPasssword() {
  ...
  const confirmNewPassword = useAppSelector(selectConfirmNewPassword)
  ...
  return (
    <div className="relative w-full h-screen bg-gray-50">
      <div className="w-full flex justify-center mx-auto container ">
        ...
        <div className="sm:w-[460px] h-[550px] w-10/12 z-10 flex rounded-[16px] items-center justify-end flex-col">
          <div className="w-full h-[450px] shadow-md bg-white px-[20px] py-[15px] z-10 flex rounded-[16px] flex-col">
            ...
            <div>
              <div className=" md:block hidden mt-[40px]">
                <ReactCodeInput
                  fields={6}
                  className={'verification'}
                  onComplete={(e) => dispatch(setNewPassword(e))}
                />
              </div>
              <div className="md:hidden block mt-[40px]">
                <ReactCodeInput
                  fields={6}
                  className={'athenticator'}
                  onComplete={(e) => dispatch(setNewPassword(e))}
                />
              </div>
            </div>
            <div className="mt-[15px]">
              <div className="w-full h-[40px] border flex justify-center items-center rounded-[8px] mt-[15px] bg-blue-500 text-white text-[14px] hover:scale-105 duration-500">
                <button>ارسال کد یکبار مصرف</button>
              </div>
            </div>
          </div>
        </div>
