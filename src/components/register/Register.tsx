  ...
  return (
    <div className="relative w-full h-screen bg-gray-50">
      <div className="w-full flex justify-center mx-auto container ">
        ...
        <div className="sm:w-[460px] h-[640px] sm:h-[860px] w-10/12 z-10 flex rounded-[16px] items-center justify-end flex-col">
          <div className="text-white sm:text-[60px] mb-[80px] text-[45px] sm:flex hidden">
            خوش آمدید
          </div>

          <div className="w-full h-[560px] shadow-md bg-white px-[20px] py-[15px] z-10 flex rounded-[16px] flex-col">
            ...
            <div className="mt-[15px]">
              ...
              <div className="w-full mt-[33px] h-[40px] border flex justify-center items-center rounded-[8px]  bg-[#0a3d67] text-white text-[14px] hover:scale-105 duration-500">
              ...
              <div className="w-full h-[40px] border flex justify-center items-center rounded-[8px]  bg-blue-500 text-white text-[14px] hover:scale-105 duration-500">
                <button>ورود</button>
              </div>
            </div>
          </div>
