  ...
  return (
    <div className="relative w-full h-screen bg-gray-50">
      <div className="w-full flex justify-center mx-auto container ">
        ...
        <div className="sm:w-[460px] md:mt-[30px] mt-[80px]  w-10/12 z-10 flex rounded-[16px] items-center justify-end flex-col gap-[20px]">
          <div className="text-white sm:text-[60px]  text-[45px] md:block hidden">
            خوش آمدید
          </div>

          <div className="w-full h-[540px] shadow-md bg-white px-[20px] py-[15px] z-10 flex rounded-[16px] flex-col">
            <div className="text-center w-full text-[23px]">ورود</div>
            <div className="flex w-full justify-center gap-2 mt-[33px]">
              <div className="border px-[24px] py-[12px] rounded-[8px]">
                <svg
                  width="24px"
                  height="32px"
                  viewBox="0 0 64 64"
            ...
            <div className="mt-[15px]">
              ...
              <div className="w-full h-[40px] border flex justify-center items-center rounded-[8px] mt-[33px] bg-blue-500 text-white text-[14px] hover:scale-105 duration-500">
                <button>ورود</button>
              </div>
              ...
              <div className="w-full h-[40px] border flex justify-center items-center rounded-[8px]  bg-[#0a3d67] text-white text-[14px] hover:scale-105 duration-500">
